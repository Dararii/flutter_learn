...
class _PriceScreenState extends State<PriceScreen> {
  ...
  void getData() async {
    try {
      ...
      double data =
          await CoinData().getCoinData(cryptoList[0], selectedCurrency);
      double data2 =
          await CoinData().getCoinData(cryptoList[1], selectedCurrency);
      double data3 =
          await CoinData().getCoinData(cryptoList[2], selectedCurrency);
      setState(() {
